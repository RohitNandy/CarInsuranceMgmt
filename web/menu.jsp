            ...
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                <div style="padding: 10px">
                    <a href="landingPage.jsp">
                        <img src="https://www.outlookindia.com/outlookmoney/public/uploads/article/gallery/9f5518fc9b70672aaba65aa3af600c32.jpg" width="150" height="100"></img></a></div>
                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <c:if test="${User.roleId == '1'}">
                        <li id="menulinks"><a href="firstnoticeofloss.jsp" class="nav-link px-2 text-white">ADD FNOL</a></li>
