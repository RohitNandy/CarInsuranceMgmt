            ...
            <main class="form-signin w-100 m-auto">
                <div class="bordered">
                    <form action="LogFNOL" method="post">
                        <img class="mb-4" src="https://www.outlookindia.com/outlookmoney/public/uploads/article/gallery/9f5518fc9b70672aaba65aa3af600c32.jpg" alt="" height="100" width="200">
                        <h3 class="h3 mb-3 fw-normal">LOG YOUR FIRST NOTICE OF LOSS</h3>
                        <table>
                            <tr>
                                <td>Your Email:</td>
                                <td>
...
<!--                            <td></td>
                    ...
                    <button class="w-25 btn btn-lg btn-success mt-4" type="submit">Submit</button>
